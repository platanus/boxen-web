...
class ApiController < ApplicationController
    ...
    protected
        ...
        def octokit_client
            ...
            # Setup Github Enterprise api and web endpoints
            ghe_url = ENV['GITHUB_ENTERPRISE_URL']
            if ghe_url
                Octokit.configure do |c|
                    c.api_endpoint = "#{ghe_url}/api/v3"
                    c.web_endpoint = "#{ghe_url}"
                end
            end

            # Authenticate to github to make the requests
